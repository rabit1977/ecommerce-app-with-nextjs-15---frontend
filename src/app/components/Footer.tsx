    ...
    <div className='bg-gray-800 dark:bg-gray-900 text-white'>
      <div className='container mx-auto px-4 py-12'>
            ...
            <div className='flex space-x-4'>
              <a href='#' className='text-gray-400 hover:text-white'>
                <svg
                  ...
                  viewBox='0 0 24 24'
                >
                  <path d='M22.675 0h-21.35C.59 0 0 .59 0 1.325v21.351C0 23.41.59 24 1.325 24H12.82v-9.294H9.692v-3.622h3.128V8.413c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.313h3.587l-.467 3.622h-3.12V24h5.713c.735 0 1.325-.59 1.325-1.325V1.325C24 .59 23.41 0 22.675 0z'></path>
                </svg>
              </a>
              <a href='#' className='text-gray-400 hover:text-white'>
                <svg
        ...
        <div className='mt-12 border-t border-gray-700 pt-8 text-center text-sm text-gray-400'>
          <p>&copy; 2024 NextGen Store. All Rights Reserved.</p>
        </div>
      </div>
    </div>
  );
